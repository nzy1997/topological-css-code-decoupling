"""Quotient translation actions for Algorithm SM.1."""

from dataclasses import dataclass, field

from sage.all import GF, Matrix

from isomorphism.algebra.quotient import quotient_module_basis
from isomorphism.rings import a, b
...
def build_quotient_translation_action(mat, *, diagnostics=False):
