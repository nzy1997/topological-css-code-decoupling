...
def construct_excitation_map(f, g):
...
def check_commutation(epsilon, num_qubits):
    ...
    return (epsilon * symplectic * antipode_matrix(epsilon)).is_zero()
