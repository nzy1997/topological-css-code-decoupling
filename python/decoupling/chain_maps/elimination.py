...
from decoupling.chain_maps.result import ClearingResult
from decoupling.css import dagger_matrix, evaluate_at_identity
...
def clear_css_mod_j(epsilon, *, num_x_checks, num_qubits):
    """Clear evaluated CSS blocks and retain ``(xi_2, xi_1, xi_0)`` maps.
    ...
    xi_2 = dagger_matrix(z_row_map)
    xi_1 = phi
    xi_0 = x_row_map.inverse()
